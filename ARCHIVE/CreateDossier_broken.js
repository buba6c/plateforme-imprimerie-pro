...
const CreateDossier = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      // Données de base
      formData.append('numero', generateNumero());
      formData.append('client', selectedType === 'roland' ? rolandData.client : xeroxData.client);
      formData.append('type_formulaire', selectedType);
      formData.append('preparateur_id', currentUser?.id);
      formData.append('statut', 'en_cours');

      // Ajouter la surface calculée pour Roland
      const dataToSend = selectedType === 'roland' 
        ? { ...rolandData, surface_m2: calculatedSurface }
        : xeroxData;

      formData.append('data_formulaire', JSON.stringify(dataToSend));
      ...
      console.log('CreateDossier - Envoi des données:', {
        type: selectedType,
        data: dataToSend,
              ...
              {selectedType === 'roland' && (
                <div className="space-y-8">
                  ...
                  <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
                    ...
                    {/* Type de support */}
                    <div className="mb-6">
                      <label className="form-label">Type de support / impression *</label>
                      <select
                  ...
                  <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
                    ...
                    {/* Oeillets */}
                    <div className="mb-6">
                      <label className="form-label">Oeillets</label>
              ...
              {selectedType === 'xerox' && (
                <div className="space-y-8">
                  ...
                  <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-200 dark:border-neutral-700 p-6">
                    ...
                    <div className="mb-6">
                      <label className="form-label">Mode d'impression *</label>
                    ...
                    <div className="mb-6">
                      <label className="form-label">Couleur d'impression *</label>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        <label
                          className={`flex items-center justify-center p-3 border-2 rounded-lg cursor-pointer transition-all ${
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {/* Grammage */}
                      <div>
                        <label className="form-label">Grammage / Type de papier *</label>
                        <select
                    ...
                    <div className="mb-6">
                      ...
                      {xeroxData.numerotation && (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3 ml-7">
                          <div>
                            <label className="form-label">Début de la numérotation</label>
                            <input
                              type="number"
                              min="1"
                          ...
                          <div>
                            <label className="form-label">Nombre de chiffres</label>
                            <input
                              type="number"
                              min="1"
                              max="10"
