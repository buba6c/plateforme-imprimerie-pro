...
const PreparateurDashboardUltraModern = ({ user }) => {
  ...
  const DossierCard = ({ dossier }) => {
    ...
    return (
      <div className="group relative bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border-2 border-gray-200 dark:border-gray-700 hover:border-blue-400/50 dark:hover:border-blue-500/50 flex flex-col h-full">
        {/* Bande de statut avec dégradé amélioré */}
        <div className={`h-1.5 sm:h-2 ${statusColors.bg} bg-gradient-to-r shadow-inner`}></div>

        <div className="p-4 sm:p-5 lg:p-6 flex-1 flex flex-col">
          {/* En-tête avec alignement amélioré */}
          <div className="flex items-start justify-between gap-2 sm:gap-3 mb-4 sm:mb-5">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-1.5 sm:gap-2 mb-1.5 sm:mb-2">
                <div className="w-1 sm:w-1.5 h-5 sm:h-6 bg-gradient-to-b from-blue-500 to-indigo-600 rounded-full flex-shrink-0"></div>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 pl-2 sm:pl-3.5">
                <div className="p-1 sm:p-1.5 rounded-md sm:rounded-lg bg-blue-50 dark:bg-blue-900/30 flex-shrink-0">
            ...
            {/* Badge statut redesigné */}
            <div className="flex-shrink-0">
              <span className={`inline-flex items-center px-2 py-1.5 sm:px-3 sm:py-2 rounded-lg sm:rounded-xl text-[10px] sm:text-xs font-bold border-2 ${statusColors.light} ${statusColors.text} ${statusColors.border} shadow-md backdrop-blur-sm`}>
                {getStatusLabel(dossier.status)}
              </span>
            </div>
          </div>

          {/* Informations avec meilleur espacement */}
          <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-6 flex-1">
            {/* Machine badge amélioré */}
            {machineConfig && (
            ...
            <div className="flex items-center gap-2 sm:gap-2.5 px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-100 dark:border-indigo-800">
              <div className="p-0.5 sm:p-1 rounded bg-indigo-100 dark:bg-indigo-800 flex-shrink-0">
                <ClockIcon className="h-3 w-3 sm:h-4 sm:w-4 text-indigo-600 dark:text-indigo-400" />
              </div>
          ...
          <div className={`grid ${canDelete ? 'grid-cols-2' : 'grid-cols-1'} gap-2 sm:gap-3 mt-auto`}>
            <button
              onClick={() => handleViewDetails(dossier)}
              className="group/btn relative flex items-center justify-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-5 sm:py-3.5 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 hover:from-blue-700 hover:via-indigo-700 hover:to-blue-700 text-white transition-all duration-300 shadow-lg shadow-blue-500/40 hover:shadow-xl hover:shadow-blue-500/60 hover:-translate-y-0.5 sm:hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] min-h-[44px] sm:min-h-0"
            >
            ...
            {canDelete && (
              <button
                ...
                className="group/btn relative flex items-center justify-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-5 sm:py-3.5 rounded-lg sm:rounded-xl font-bold text-xs sm:text-sm bg-gradient-to-r from-red-600 via-pink-600 to-red-600 hover:from-red-700 hover:via-pink-700 hover:to-red-700 text-white transition-all duration-300 shadow-lg shadow-red-500/40 hover:shadow-xl hover:shadow-red-500/60 hover:-translate-y-0.5 sm:hover:-translate-y-1 hover:scale-[1.02] active:scale-[0.98] min-h-[44px] sm:min-h-0"
              >
                <div className="absolute inset-0 rounded-lg sm:rounded-xl bg-white/20 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                <TrashIcon className="h-4 w-4 sm:h-5 sm:w-5 relative z-10 flex-shrink-0" />
                <span className="relative z-10 truncate">Supprimer</span>
              </button>
            )}
          </div>
        </div>
        ...
        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
          <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-blue-500/20 via-indigo-500/20 to-purple-500/20 blur-xl"></div>
        </div>
      </div>
    );
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-900 p-3 sm:p-4 lg:p-6">
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-5 lg:space-y-6">
        ...
        <div className="relative bg-white dark:bg-gray-800 rounded-2xl sm:rounded-3xl shadow-xl border border-gray-200 dark:border-gray-700 p-4 sm:p-6 lg:p-8 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-blue-600/5 via-indigo-600/5 to-purple-600/5 dark:from-blue-400/5 dark:via-indigo-400/5 dark:to-purple-400/5"></div>
          
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4">
            <div>
              <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 dark:from-blue-400 dark:via-indigo-400 dark:to-purple-400 bg-clip-text text-transparent mb-1.5 sm:mb-2">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-1.5 sm:gap-2 px-4 py-2.5 sm:px-6 sm:py-3 text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 rounded-lg sm:rounded-xl transition-all duration-200 shadow-lg shadow-blue-500/30 hover:shadow-xl hover:shadow-blue-500/40 hover:-translate-y-0.5 min-h-[44px] sm:min-h-0"
              >
