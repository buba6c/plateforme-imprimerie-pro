...
// FactureSimple: modèle de facture minimaliste
// Props attendues: { data: { company, client, meta, items, totals, notes } }
const FactureSimple = ({ data }) => {
  const d = data || {};
    ...
    <div className="mx-auto bg-white text-gray-900 shadow-sm border border-gray-200 rounded-lg overflow-hidden max-w-3xl">
      ...
      <div className="p-6 border-b border-gray-200 flex items-start justify-between">
        <div>
          ...
          {meta?.dueDate && (
            <p className="text-sm text-gray-600">Échéance: {meta.dueDate}</p>
          )}
        </div>
      ...
      <div className="grid grid-cols-2 gap-6 p-6">
        <div>
          <h2 className="text-sm font-semibold text-gray-700 mb-2">VENDEUR</h2>
        ...
        <div>
          <h2 className="text-sm font-semibold text-gray-700 mb-2">CLIENT</h2>
          <div className="text-sm">
