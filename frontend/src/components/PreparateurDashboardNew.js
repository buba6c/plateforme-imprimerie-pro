    ...
    return (
      <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-neutral-600 dark:text-neutral-300">Chargement des dossiers...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-300">Total Dossiers</p>
                <p className="text-3xl font-bold text-blue-600 mt-2">{stats.total}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Tous statuts confondus</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-300">En Cours</p>
                <p className="text-3xl font-bold text-orange-600 mt-2">{stats.enCours}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Nécessitent une action</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-300">Terminés</p>
                <p className="text-3xl font-bold text-success-600 mt-2">{stats.termine}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">{stats.pourcentageCompletion}% complétés</p>
              </div>
          ...
          >
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium text-neutral-600 dark:text-neutral-300">Urgents</p>
                <p className="text-3xl font-bold text-error-600 mt-2">{stats.enRetard}</p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400 mt-1">Nécessitent attention</p>
              </div>
